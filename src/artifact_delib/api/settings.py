...
class Settings(BaseSettings):
    """Safe-by-default configuration for local and remote artifact identification runs."""
    ...
    artifact_delib_env: str = "development"
    artifact_delib_run_mode: str = "fixture"
    artifact_delib_data_root: Path = Path("data")
    artifact_delib_output_root: Path = Path("outputs")
    artifact_delib_cache_root: Path = Path(".cache/artifact_delib")
